  ...
  return (
    <div className="w-full max-w-sm">
      ...
      <div className="text-center mb-8">
        <h1 className="font-syne font-700 text-3xl text-[var(--text-primary)] mb-2">Welcome back</h1>
        <p className="text-sm text-[var(--text-muted)]">Sign in to continue to Spendly</p>
      </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                name="password" type={showPwd ? 'text' : 'password'} placeholder="Your password"
